...
contract RedeemCollateral is Script {
    ...
    uint256 redeemAmount = 100e18 ;// user wants to redeem 400 pusd
    ...
    function run() public {
        ...
        console.log("pusd balance before",IERC20(pusd).balanceOf(user)/1e18);
        TroveManager.redeemCollateral(truncatedpusdamount,firstRedemptionHint, upperHint,lowerHint,partialRedemptionNewICR,0, /*maxFee */5e16);
        console.log("pusd balance afyer",IERC20(pusd).balanceOf(user)/1e18);
